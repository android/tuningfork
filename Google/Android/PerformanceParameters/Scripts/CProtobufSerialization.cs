...
namespace Google.Android.PerformanceParameters
{
    ...
    public struct CProtobufSerialization
    {
        ...
        private delegate void DeallocCallback(ref CProtobufSerialization parameters);

        [MonoPInvokeCallback(typeof(DeallocCallback))]
        private static void DeallocCallbackImpl(ref CProtobufSerialization parameters)
        {
        ...
        public T ParseMessage<T>(MessageParser<T> parser) where T : class, IMessage<T>, new()
        {
