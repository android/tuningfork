...
namespace Google.Android.PerformanceParameters.Editor.Proto
{
    ...
    public class EnumInfoHelper
    {
        ...
        private readonly IList<EnumDescriptor> m_EnumTypes;
        ...
        internal List<EnumInfo> CreateInfoList()
        {
        ...
        private static readonly Regex SceneFieldRegex = new Regex("[^a-zA-Z0-9_]");
        ...
        public static EnumInfo GetSceneEnum(EditorBuildSettingsScene[] scenes)
        {
            ...
            foreach (var scene in scenes)
            {
                ...
                var sceneName = scene.path
                    ...
                    .Replace(" ", "_")
                    .ToUpper();
                sceneName = SceneFieldRegex.Replace(sceneName, "");
        ...
        public static EnumInfo GetLoadingStateEnum()
        {
            return new EnumInfo
            {
